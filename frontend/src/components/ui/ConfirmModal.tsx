...
export default function ConfirmModal({
  ...
  const getConfirmButtonStyles = () => {
    const baseStyles = "px-5 py-2.5 rounded-lg font-medium transition-all duration-200 focus:outline-none focus:ring-2 backdrop-blur-sm border shadow-sm"
  ...
  return (
    <div className="fixed inset-0 z-[9999] overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center p-4">
        ...
        {/* Message */}
        <div className="mb-6">
          <p className="text-white/90 text-sm leading-relaxed font-medium" style={{ textShadow: '1px 1px 2px rgba(0, 0, 0, 0.6)' }}>
            {message}
          </p>
        </div>
