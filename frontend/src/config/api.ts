...
export const apiUrls = {
  ...
  habits: {
    ...
    unmark: (habitId: string) =>
      buildApiUrl(API_ENDPOINTS.HABITS.UNMARK(habitId)),
    deleteEntry: (entryId: string) =>
      buildApiUrl(API_ENDPOINTS.HABITS.DELETE_ENTRY(entryId)),
  },
  ...
  transactions: {
    ...
    categoriesFinance: () =>
      buildApiUrl(API_ENDPOINTS.TRANSACTIONS.CATEGORIES_FINANCE),
    categoriesDefaults: () =>
      buildApiUrl(API_ENDPOINTS.TRANSACTIONS.CATEGORIES_DEFAULTS),
